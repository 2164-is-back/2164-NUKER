...
def main():
    ...
    # Set Console title
    set_console_title("2164 V1 | Menu")
 ...
 v1.0
                        ╔═════════════════════════╗         ╔═════════════════════════╗
                        ║    discord.gg/2164      ║         ║     discord.gg/2164     ║
                     ╔═══════════════════════════════╗   ╔═══════════════════════════════╗
    ...
    info = f"""{Fore.LIGHTCYAN_EX}\t\t\t\t\t  [+] Made by .gg/2164 [+]"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
...
# ========================================================================================================================================================= #
    ...
    if choice == "1":
        ...
        message = "@here Nuked by https://github.com/2164-is-back"
...
def socials():
    ...
    # Set Console title
    set_console_title("2164 V1 | Socials")
    ...
    print()
    time.sleep(2)
    input("Clique sur une touche pour continuer...")
